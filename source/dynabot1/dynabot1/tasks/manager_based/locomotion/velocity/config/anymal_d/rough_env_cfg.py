...
#from isaaclab_assets.robots.dynabot import DYNABOT_1_CFG  # isort: skip
##
# Pre-defined configs
##
#from omni.isaac.lab_assets.dynabot import DYNABOT_1_CFG  # isort: skip
...
class AnymalDRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        # rewards
        self.rewards.feet_air_time.params["sensor_cfg"].body_names = ".*hand_link"
        ...
        self.rewards.flat_orientation_l2.weight = -0.0002
