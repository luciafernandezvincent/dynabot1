...
def load_sim(sim_joint: str, sim_joint_graph):
...
def plot_joint_position(sim_joint: str, real_key: str, csv_key: str):
    ...
    # Moved joint
    sim  = load_sim(sim_joint, sim_joint)
    real = load_real(real_key, csv_key)
    ...
    for other_sim_joint, other_real_key, _ in filtered_joint_map:
        sim  = load_sim(sim_joint, other_sim_joint)
        real = load_real(other_real_key, csv_key)
