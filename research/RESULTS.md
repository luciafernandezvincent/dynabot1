...
| 3 | exp_009_long_swing | 0.5694 | 33.3 | 0.974 | 0.994 | 0.138 | 0.986 | 54.3 | 0.003 | 2.73 | 0.49 | swing mas largo via clearance w=1.0 target 8cm (el umbral de air_time resulto contraproducente) |
| 4 | baseline_ar | 0.4790 | 22.9 | 0.972 | 0.989 | 0.117 | 0.987 | 74.8 | 0.023 | 3.07 | 0.47 | baseline de referencia, defaults del codigo |
| 5 | exp_002_airtime_threshold_fix | 0.4459 | 23.9 | 0.971 | 0.988 | 0.108 | 0.986 | 65.4 | 0.036 | 3.96 | 0.50 | CAUSA RAIZ: threshold 0.5->0.12s aislado vs baseline (sin clearance) |
