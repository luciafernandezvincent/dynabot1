...
QUEUE = [
    ...
    ("exp_002_airtime_threshold_fix.yaml", "exp_002_airtime_threshold_fix", "CAUSA RAIZ: threshold 0.5s->0.12s aislado"),
    ("exp_009_long_swing.yaml", "exp_009_long_swing", "swing mas largo: air_time w=2.0 thr=0.12 + clearance"),
    ...
    ("exp_012_elegant_combo.yaml", "exp_012_elegant_combo", "combo: swing largo + trote + simetria + despeje"),
    ("exp_003_airtime_fix_plus_clearance.yaml", "exp_003_airtime_fix_plus_clearance", "umbral corregido + clearance"),
